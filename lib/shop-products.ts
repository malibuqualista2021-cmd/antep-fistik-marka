...
export const retailProducts: RetailProduct[] = [
  {
    ...
    imageAlt: "Kasede kavrulmuş kabuklu Antep fıstığı; günlük tüketim ve ikramlık seri",
    price: 390,
    currency: "TRY",
    weight: "500 g",
    variants: [
  ...
  },
  {
    ...
    imageAlt: "Keten üzerinde taze ayıklanmış yeşil iç Antep fıstığı — baklavalık seri",
    price: 520,
    currency: "TRY",
    weight: "250 g",
    variants: [
  ...
  },
  {
    ...
    imageAlt: "Baklavalık ve pastalık için yeşil Antep fıstığı tozu ve boz iç serisi",
    price: 480,
    currency: "TRY",
    weight: "250 g",
    variants: [
  ...
  },
  {
    ...
    imageAlt: "Hediye ve ikram için kabuklu, iç ve paketli Antep fıstığı perakende serisi",
    price: 690,
    currency: "TRY",
    weight: "1 kg",
    variants: [
